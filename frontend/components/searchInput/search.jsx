...
export const Search = ({ searchItem, onChange, onClick }) => {
  ...
  return (
    <div classNameName="flex justify-end space-x-10 bg-inherit ">
      ...
      <form className="flex items-center max w-1/5">
        ...
        <div classNameName="bg-white shadow-lg rounded-md overflow-hidden h-[25rem] cursor-pointer">
          <span classNameName="px-3 py-2 block font-bold text-xl"></span>
        </div>
